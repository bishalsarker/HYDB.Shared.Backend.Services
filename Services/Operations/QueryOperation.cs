...
namespace HYDB.Services.Services
{
    public class QueryOperation : IOperation
    {
        ...
        /*
                public Response Run(QueryScript script, IDictionary<string, object> args, string userId)
                {
                    return Execute(script, userId, GetArgDictionary(args));

                    //var operation = ResolveOperation(operationRequest.Operation, operationRequest.Service, userId);
                    ...
                    //    });
                    //    return Execute(script, userId, GetArgDictionary(operationRequest.Args));
                    //}
                    //else
                    //{
                    //    return new Response()
